    ...
    <div>
        ...
        <div class="primaryCoverage">
            <div class="primaryCoverage2">
                <div class="leftBox">
                    <img src="../assets/parts/11.png" alt="" class="partsBox" @click="showObj(1)">
                    <img src="../assets/parts/12.png" alt="" class="partsBox" @click="showObj(2);showObj(3)">
                    <img src="../assets/parts/13.png" alt="" class="partsBox" @click="showObj(4)">
                    <img src="../assets/parts/14.png" alt="" class="partsBox" @click="showObj(5)">
                </div>
                <div class="obj">
                    <loadobj ref="obj"></loadobj>
                </div>
                <div class="rightBox">
                    <img src="../assets/parts/15.png" alt="" class="partsBox" @click="showObj(6)">
                    <img src="../assets/parts/16.png" alt="" class="partsBox" @click="showObj(8)">
                    <img src="../assets/parts/17.png" alt="" class="partsBox" @click="showObj(9)">
                    <img src="../assets/parts/18.png" alt="" class="partsBox" @click="showObj(7)">
                </div>
            </div>
        </div>
    </div>
...
import loadobj from '../components/loadobj2';
