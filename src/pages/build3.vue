    ...
    <div>
        ...
        <div class="primaryCoverage">
            <div class="primaryCoverage2">
                <div class="leftBox">
                    <div class="partsBox" @click="showObj(1)">柱子</div>
                    <div class="partsBox" @click="showObj(2);showObj(3)">屋顶</div>
                    <div class="partsBox" @click="showObj(4)">围栏</div>
                    <div class="partsBox" @click="showObj(5)">梯子</div>
                </div>
                <div class="obj">
                    <loadobj ref="obj"></loadobj>
                </div>
                <div class="rightBox">
                    <div class="partsBox" @click="showObj(6)">墙</div>
                    <div class="partsBox" @click="showObj(8)">基座</div>
                    <div class="partsBox" @click="showObj(9)">窗户</div>
                    <div class="partsBox" @click="showObj(7)">其他</div>
                </div>
            </div>
        </div>
    </div>
...
.partsBox{
    ...
    color: #6d4621;
    cursor: pointer;
    background-image: url(../assets/componentBox.png);
    background-repeat:no-repeat;
    background-size:cover;
}
.leftBox{
