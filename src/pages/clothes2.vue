    ...
    <div>
        ...
        <div class="primaryCoverage">
            <div class="primaryCoverage2">
                <div class="gender">
                    <img src="../assets/clothes/girl2.png" alt="" ref="gimg" class="genderimg" >
                    <img src="../assets/clothes/boy.png" alt=""  ref="bimg" class="genderimg hide">
                    <img src="../assets/clothes/switch.png" alt="" class="textBox">
                ...
                <img src="../assets/clothes/glb2.png" v-if="gender===1" alt="" id="glb">
                <img src="../assets/clothes/costume2.png" alt="" id="hanchao">
    ...
    methods: {
        ...
        goto(number){
            ...
            if(number===1){
                ...
                this.$parent.save('/clothes2',2,1);
                this.$router.push({path:'/pk'})
            }else if(number===7){
                this.$parent.save('/toushi3',0,0);
                this.$router.push({path:'/toushi3'})
            }
        },
    }
}
