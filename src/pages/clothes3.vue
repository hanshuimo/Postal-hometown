    ...
    <div>
        ...
        <div class="primaryCoverage">
            <div class="primaryCoverage2">
                <div class="gender">
                    <img src="../assets/clothes/girl3.png" alt="" ref="gimg" class="genderimg" >
                ...
                <img src="../assets/clothes/glb3.png" v-if="gender===1" alt="" id="glb">
                <img src="../assets/clothes/costume3.png" alt="" id="hanchao">
