    ...
    <div>
        <div class="primaryCoverage3">
            <div class="leftTop">
                ...
                <div @click="goto(5)">&gt;&gt;苗族民歌&gt;&gt;</div>
                <div class="title"> 
                    <div>大富翁</div>
                </div>
            </div>
            <pages ref="mychild"></pages>
            <div class="pk" @click="goto(6)">
                PK
            </div>
        </div>
        ...
        <div class="primaryCoverage">
            <div class="gamecontainer">
                <img src="../assets/game/gamer3.png" alt="" class="gamer" :style="{left:now.left,top:now.top}">
        ...
        <div class="box hide" ref="wrong">
            <div class="question wrong">
                <h1>回答错误！</h1>
                <img src="../assets/game/btn3.png" alt="" @click="wrong()" class="wrongimg">
            </div>
        </div>
    </div>
</template>
...
.gamecontainer{
    ...
    top: 52px;
    margin: 0 104.6px;
    background-image: url(../assets/game/map2.png);
    background-repeat:no-repeat;
    background-size:cover;
}
.gamer{
...
export default {
    ...
    mounted() {
        ...
        this.$refs.mychild.pageupdate(5);
    ...
    methods: {
        ...
        goto(number){
            ...
            if(number===1){
                ...
                this.$router.push({path:'/unique2'})
            }else if(number===6){
                this.$router.push({path:'/gamepk2'})
            }
        },
        sleep(wait){
