...
export default {
    ...
    data() {
        return {
            ...
            photoes: [{
                id: 1,
                img: require('../assets/dikeHead/22.png')
            }, {
                id: 2,
                img: require('../assets/dikeHead/6780.png')
            }, {
                id: 3,
                img: require('../assets/dikeHead/6789.png')
            }, {
                id: 4,
                img: require('../assets/dikeHead/6790.png')
            }],
            selected: {
                id: 0,
                img: require('../assets/clothes/head1.png')
            },
            timer:null,
        }
    },
    ...
    methods: {
        ...
        changePhoto(photoId) {
            this.$parent.save('/toushi',1,photoId);
