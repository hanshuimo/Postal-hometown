...
import photoProjection from '../components/photoProjection3';
...
export default {
    ...
    data() {
        return {
            ...
            photoes: [{
                id: 1,
                img: require('../assets/bHead/1.png')
            }, {
                id: 2,
                img: require('../assets/bHead/2.png')
            }, {
                id: 3,
                img: require('../assets/bHead/3.png')
            }, {
                id: 4,
                img: require('../assets/bHead/4.png')
            }],
            selected: {
                id: 1,
                img: require('../assets/bHead/1.png')
    ...
    methods: {
        ...
        changePhoto(photoId) {
            this.$parent.save('/toushi2',1,photoId);
