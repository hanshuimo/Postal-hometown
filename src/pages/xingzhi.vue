<template>
    <div>
        ...
        <div class="primaryCoverage">
            ...
            <photo-projection2 :selectedPhoto="selected"></photo-projection2>
        </div>
    </div>
</template>
...
import photoProjection2 from '../components/photoProjection2';
...
export default {
    ...
    data() {
        return {
            ...
            photoes: [{
                id: 1,
                img: require('../assets/shape/1.png')
            }, {
                id: 2,
                img: require('../assets/shape/2.png')
            }, {
                id: 3,
                img: require('../assets/shape/3.png')
            }],
            selected: {
                id: 1,
                img: require('../assets/shape/cloak.png')
            },
            timer:null,
        }
    },
    ...
    methods: {
        ...
        changePhoto(photoId) {
            this.$parent.save('/xingzhi',1,photoId);
            photoId=photoId-1;
            this.selected = this.photoes[photoId];
        }
    }
}
</script>